...
🧪 **Automação como Código** · ⚙️ **Qualidade em Escala** · 🚀 **Entrega Confiável**

</div>

---

## 🧠 Sobre mim — Mentalidade SDET

Sou **SDET / QA Automation Engineer**, com forte base em **engenharia de software**, atuando na construção de **qualidade desde o código até a produção**.

Graduado em **Análise e Desenvolvimento de Sistemas** e pós-graduado em **Gestão de Projetos**, trabalho com foco em **automação de testes, arquitetura de qualidade, métricas e integração contínua**, garantindo **performance, confiabilidade e escalabilidade** dos sistemas.

> 💡 *Qualidade não é uma fase. É parte da arquitetura.*

---

## 🧪 O que faço como SDET
...
- Validação de **APIs REST e microsserviços**
- Qualidade orientada a **métricas, risco e impacto no negócio**
...
📅 jun/2025 – nov/2025 · 🌍 Remoto  

- Atuação em QA para **Software Project Management (SPM)**
- Automação e execução de testes funcionais e regressivos
- Escrita e manutenção de cenários **BDD**
- Validação de fluxos **ITSM e ITOM**
- Testes de integração entre sistemas
- Gestão de defeitos baseada em **impacto e criticidade**
- Apoio a métricas de qualidade e melhoria contínua
...
📅 jan/2025 – mai/2025 · 🌍 Remoto  

- Arquitetura de **frameworks de automação de testes**
- Liderança técnica em qualidade
- Integração de testes automatizados em **CI/CD**
- Definição de padrões, boas práticas e governança de testes
...
📅 dez/2024 – mai/2025 · 🌍 Remoto  

- QA voluntário no aplicativo **Glicare**
...
📅 ago/2024 – nov/2024 · 🌍 Remoto  

- Desenvolvimento backend com **Java + Spring Boot**
- Criação de **APIs REST** para sistemas de folha de pagamento
- Testes automatizados integrados ao desenvolvimento
- Atuação em sistemas críticos e regulatórios
...
## ✨ Engenharia de Qualidade. Confiança na Entrega.
